...
file_contents = []
file_paths = ["北京联通.txt", "上海电信.txt", "江苏电信.txt", "天津联通.txt", "湖北电信.txt", "湖南电信.txt", "广东电信.txt", "陕西电信.txt", "四川电信.txt", "河北电信.txt", "河南电信.txt", "重庆电信.txt", "河南联通.txt"]  # 替换为实际的文件路径列表
...
# 任务结束，删除不必要的过程文件
files_to_remove = ["北京联通.txt", "上海电信.txt", "江苏电信.txt", "天津联通.txt", "湖北电信.txt", "湖南电信.txt", "广东电信.txt", "陕西电信.txt", "四川电信.txt", "河北电信.txt", "河南电信.txt", "重庆电信.txt", "河南联通.txt", "GAT.txt", "DD.txt", "TW.txt", "a.txt", "b.txt", "b2.txt", "HK.txt", "c.txt", "c1.txt", "c2.txt", "e.txt", "f.txt", "f1.txt", "df.txt", "df1.txt", "TT.txt", "zhibo.txt"]
